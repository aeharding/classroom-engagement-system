    ...
    <script type="text/javascript" src="../../js/bootstrap.js"></script>
		...
		<script type="text/javascript">
			function submitURL() {
				...
				document.location.href = "confirm.php?id=<?php echo $qid; ?>&vote=" + answer;
			}
		</script>
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span6 offset3" style="text-align:center">
						<textarea id="answer" rows="4" maxlength="300"></textarea>
						<br>
						<a onclick="submitURL()" class="btn btn-large btn-primary">Submit</a>
					</div>
					<div class="row-fluid">
						<div class="span6 offset3" style="text-align:center">
							<br>
